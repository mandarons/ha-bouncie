...
with open("./allure-report/widgets/summary.json", encoding="utf-8") as f:
...
with open(badges_directory + "/tests.svg", "w", encoding="utf-8") as f:
...
with open(badges_directory + "/coverage.svg", "w", encoding="utf-8") as f:
    f.write(response.text)
